...
function [f,f2,f20] = force_cal(r,phase,h,Q,k)
...
if sfun0==0
    ...
    for i=1:length(r(1,:))
        r1=flip(r(:,i));
        phase1=flip(phase(:,i));
        % r1=sgolayfilt(r1,1,3);
        % phase1=sgolayfilt(phase1,1,3);
        h1=flip(h00(:,i));
        
        phase0=max(phase1);
        phase1=phase1+90-phase0;
        
        kappa=(k*max(r1)/Q.*sqrt(r1./2).*cos(phase1/180*pi));
        f1=[];
        ...
        for i1=1:length(r1)
            ...
            i2=find(h1>(h1(i1)+2*r1(i1)),1)-1;
            %disp(i1);
            f1(i1)=0;
            for i3=i1+1:i2
                f1(i1)=f1(i1)+kappa(i3)/sqrt(h1(i3)-h1(i1))*(h1(i3+1)-h1(i3));
            end
        end
        % assignin("base",'f1',r);
        ...
        for i1=1:length(f1)-1
            ...
            f(i1,i)=-(f1(i1+1)-f1(i1))/(h1(i1+1)-h1(i1));
        end
    end
end
f=flip(f,1);
